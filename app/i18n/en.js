export default {
  ...
  market: {
    ...
    acceptOfferEmailError: "Offer accepted, but emails could not be sent. Reference: {{id}}",
    ...
    offerSwipeHint: "Swipe left or right to accept or refuse an offer",
