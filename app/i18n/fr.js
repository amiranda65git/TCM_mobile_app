export default {
  ...
  market: {
    ...
    acceptOfferEmailError: "Offre acceptée, mais les emails n'ont pas pu être envoyés. Référence : {{id}}",
    ...
    offerSwipeHint: "Glisser à gauche ou à droite pour accepter ou refuser une offre",
